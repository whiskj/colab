import sys
sys.path.append('/home/system/CosyVoice/third_party/Matcha-TTS')
...
source_speech_16k = load_wav('trump.wav', 16000)
...
for i, j in enumerate(cosyvoice.inference_instruct('<strong>Hey babe</strong> how are you doing, so can you like umm... [laughter] help me write a birthday message for my sister? I\'m terrible with words and want to say something meaningful. but i keep drawing a blank.', '中文男', 'Theo \'Crimson\', is a fiery, passionate rebel leader. Fights with fervor for justice, but struggles with impulsiveness.', stream=False)):
